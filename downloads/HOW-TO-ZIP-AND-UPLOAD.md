...
## Part 0 — Status & The Final 2 Manual Steps

### What's done automatically (no action needed)
- ✅ All 8 products are LIVE on Gumroad and purchasable
- ✅ Each product's description embeds the brand-aligned thumbnail (visible above-the-fold on the product page)
- ✅ All 8 thumbnail PNGs are pre-generated at `downloads/thumbnails/productN.png`

### What needs your 30-second manual touch

The **Cover banner** (the wide gray placeholder at the very top of each product page) and the **Thumbnail** (small square shown in marketplace cards) use Gumroad's React-managed file picker that's impervious to MCP automation. You drag-and-drop the PNG onto two spots per product. **3 minutes total for all 8.**

Steps for each product (~20 seconds each):

1. Open the edit URL (table below)
2. **Drag-and-drop** the matching `downloads/thumbnails/productN.png` onto the wide gray **Cover** area at the top of the page
3. **Drag-and-drop** the same PNG onto the smaller square **Thumbnail** box just below the Cover
4. Click **Save changes** (top-right)

That's it.

| # | Edit URL | PNG to drop |
|---|---|---|
| 1 | https://app.gumroad.com/products/oeazx/edit | `downloads/thumbnails/product1.png` |
| 2 | https://app.gumroad.com/products/ngnwww/edit | `downloads/thumbnails/product2.png` |
| 3 | https://app.gumroad.com/products/nxkdft/edit | `downloads/thumbnails/product3.png` |
| 4 | https://app.gumroad.com/products/ukoykb/edit | `downloads/thumbnails/product4.png` |
| 5 | https://app.gumroad.com/products/ufwjj/edit | `downloads/thumbnails/product5.png` |
| 6 | https://app.gumroad.com/products/mpuwxl/edit | `downloads/thumbnails/product6.png` |
| 7 | https://app.gumroad.com/products/kjeti/edit | `downloads/thumbnails/product7.png` |
| 8 | https://app.gumroad.com/products/qyjkl/edit | `downloads/thumbnails/product8.png` |

### Optional clean-up: remove the embedded description image

I auto-uploaded each thumbnail as an embedded image at the top of each product's description body. It looks good there, but if you'd prefer the description not to lead with the image (since you'll have a proper Cover banner above it), do this:

1. On each edit page, click into the **Description** rich-text editor
2. Click the brand image at the top
3. Press Backspace or Delete
4. Save

(Or just leave it — having a branded image both as Cover AND inside the description doubles your branding impact.)

### Why I couldn't automate the Cover

Gumroad's Cover upload uses a button that triggers a React-managed flow with no targetable `<input type="file">` in the DOM (no input gets created on click, no drag-drop zone responds to synthetic events, the actual upload happens through their internal upload service after the native file picker fires). Mixed-content blocking (HTTPS → HTTP localhost) prevented a workaround through a local file server. The cleanest path is the 20-second manual drag-and-drop above.

---

## Part 0.5 — Upload the 8 Cover Thumbnails (Original Instructions)
